echo "--- Executing initialization force file for ../testcode/mp22cp2test.asm ---"
...
echo "Done initializing processor, loading ../testcode/mp22cp2test.asm program code."
run 5
...
change mp2_cpu/dram/pdram/vhdl_memory/mem(17) X"64"
change mp2_cpu/dram/pdram/vhdl_memory/mem(18) X"0F"
change mp2_cpu/dram/pdram/vhdl_memory/mem(19) X"B4"
change mp2_cpu/dram/pdram/vhdl_memory/mem(20) X"0E"
change mp2_cpu/dram/pdram/vhdl_memory/mem(21) X"68"
change mp2_cpu/dram/pdram/vhdl_memory/mem(22) X"0D"
...
run 5
echo "Done loading ../testcode/mp22cp2test.asm program code."
