...
ARCHITECTURE struct OF Stage_Memory IS
   ...
   SIGNAL MEM_MARout2 : LC3b_word;
   SIGNAL MEM_MDRout2 : LC3b_word;
   SIGNAL MREAD_L2    : std_logic;
   SIGNAL MWRITE_L2   : std_logic;
