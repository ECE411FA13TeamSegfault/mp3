...
ARCHITECTURE struct OF Datapath IS
   ...
   SIGNAL CheckN_internal : std_logic;
   SIGNAL CheckP_internal : std_logic;
   SIGNAL CheckZ_internal : std_logic;
   ...
   FOR ALL : pulse45 USE ENTITY ece411.pulse45;
   -- pragma synthesis_on
...
BEGIN
   ...
   aStage_WB : Stage_WB
      PORT MAP (
         ...
         WB_dest           => MEM_dest,
         clk               => clk,
         CheckN            => CheckN_internal,
         CheckP            => CheckP_internal,
         CheckZ            => CheckZ_internal,
